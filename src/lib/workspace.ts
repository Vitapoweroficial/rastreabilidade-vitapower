...
export const workspaceModules = [
  ...
  { slug: "engenharia", href: "/admin/produtos", label: "Engenharia", shortLabel: "Engenharia", description: "Produtos, fórmulas, BOM, insumos e precificação.", status: "Base ativa", icon: FlaskConical },
