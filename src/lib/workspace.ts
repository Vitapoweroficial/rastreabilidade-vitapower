import { BarChart3, ClipboardCheck, Factory, FileBadge2, FlaskConical, Landmark, PackageCheck, Settings2, ShoppingCart, UsersRound, Warehouse } from "lucide-react";
...
export const workspaceModules = [
  ...
  { slug: "private-label", href: "/admin/modulos/private-label", label: "Private Label", shortLabel: "Private Label", description: "Briefing, fórmula, precificação, proposta, aprovação, OP e rastreabilidade.", status: "Operacional", icon: ClipboardCheck },
  { slug: "engenharia", href: "/admin/engenharia", label: "Engenharia", shortLabel: "Engenharia", description: "Produtos, fórmulas, BOM, insumos, embalagens e custos.", status: "Base ativa", icon: FlaskConical },
  { slug: "pcp", href: "/admin/modulos/pcp", label: "Produção / PCP", shortLabel: "PCP", description: "OPs, etapas produtivas, apontamentos e gargalos.", status: "Integrado ao Private Label", icon: Factory },
...
export function getWorkspaceModule(slug: string) { return workspaceModules.find((module) => module.slug === slug); }
